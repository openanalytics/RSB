...
<!-- Page only rendered for authorized users -->
<sec:authorize access="isAuthenticated() and hasPermission(T(eu.openanalytics.rsb.Constants).ADMIN_PATH, 'RSB_RESOURCE')">
<%!
    //FEATURES
    ...
    */
     ...
     */
    private static final String CSS_NAME = "file-browser.css";
    /**
