...
public class RmiRServiInstanceProvider implements RServiInstanceProvider {
    ...
    private static class PooledRServiWrapper implements RServi {
        ...
        PooledRServiWrapper(final KeyedObjectPool<RServiPoolKey, PooledRServiWrapper> rServiPool, final RServiPoolKey key,
                final RServi rServi) {
        ...
        public void downloadFile(final OutputStream out, final String fileName, final int options, final IProgressMonitor monitor)
